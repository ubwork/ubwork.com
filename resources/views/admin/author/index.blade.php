            ...
            <div class="card-header">
              ...
              <form action="" class="form-inline float-right mr-3">
                <div class="form-group">
                    <input class="form-control" name="key" id="key" placeholder="Nhập tên tác giả....">
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped dataTable dtr-inline">
                ...
                <tr>
                  ...
                  <th>{{__('Slogan')}}</th>
                  <th>{{__('Trạng thái')}}</th>
                  <th><a href="{{route('admin.author.create')}}"><i class="fa fa-plus"></i></a></th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->slogan}}</td>
                        <td>
                          <form action="{{route('admin.author.status', ['id' => $item->id])}}" method="post">
                            @csrf
                            @method('post')
                        ...
                        <td class="project-actions xoa text-right d-flex align-items-center">
                            <a class="btn btn-info mr-3" href="{{route('admin.author.edit', ['id' => $item->id])}}">
