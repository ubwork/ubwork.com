                  ...
                  <form action="{{ route('admin.blog.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-lg-12 col-md-12">
                          <label>Mô tả</label>
                          <textarea class="description form-control" rows="4"  name="description" placeholder="">{{old('description')}}</textarea>
                          @error('description')
                    ...
                    <div class="row">
                      <div class="form-group col-lg-12 col-md-12">
                          ...
                          <textarea class="content form-control" rows="4"  name="content" placeholder="">{{old('content')}}</textarea>
                          @error('content')
                          <div class="text-danger pl-4">
                              {{ $message }}
                          </div>
