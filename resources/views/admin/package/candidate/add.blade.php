    ...
    <div class="container-fluid">
        <div class="">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <form action="{{ route('admin.package.candidate.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- text input -->
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{route('admin.package.candidate.index')}}" class="btn btn-secondary">{{__('Hủy')}}</a>
                    </div>
                  </form>
                </div>
                <!-- /.card-body -->
