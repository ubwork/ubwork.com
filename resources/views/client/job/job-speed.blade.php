...
@section('title')
    {{ __('UB Work') }} | {{ __('Công việc đã ứng tuyển nhanh') }}
@endsection
...
@section('content')
    ...
    <div class="auto-container">
        <div class="title-outer">
            <h1>Công việc đã tìm kiếm nhanh</h1>
        </div>
    </div>
    </section>
                          ...
                          <td>
                            <div class="option-box">
                              <ul class="option-list">
                                <li><a target="_blank" href="{{route('job-detail', ['id' => $item->job_post_id])}}"><button data-text="View Aplication"><span class="la la-eye"></span></button></a></li>
                              </ul>
                            </div>
                          </td>
                        </tr>
