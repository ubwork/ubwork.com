        ...
        <div class="upper-box">
            <div class="auto-container">
                ...
                <div class="job-block-seven">
                    <div class="inner-box">
                        <div class="content">
                            <span class="company-logo"><img src="{{asset('images/company/'.$company_detail->logo)}}" alt=""></span>
                ...
                <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-lg-12 col-md-12">
                        ...
                        <textarea type="text" name="like_text" placeholder="Điều bạn thích ở ứng viên này" value=""></textarea>
                        @error('like_text')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                      </div>
                      ...
                      <div class="form-group col-lg-12 col-md-12">
                        ...
                        <textarea type="text" name="improve" placeholder="Điều ứng viên cần cải thiện" value=""></textarea>
                        @error('improve')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                      </div>
