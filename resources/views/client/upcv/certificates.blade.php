...
<div class="list-certificates mt-3">
    ...
    <form id="form-border-cer{{$cer->id}}" class="d-flex mt-3 border-dotted-bot" action="{{route('deleteCertificate', ['id' => $cer->id])}}" method="get">
        ...
        <div id="btnFormCer{{$cer->id}}" style="width: 10%;">
            <button type="submit" onclick="return Del({{$cer->id}})" style="float: right;"><i class="fa fa-trash" aria-hidden="true"></i></button>
