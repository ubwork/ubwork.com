                ...
                <form class="default-form" action="{{route('company.profile.update')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="uploading-outer">
                    <div class="uploadButton">
                      ...
                      <label class="uploadButton-button ripple-effect fileupload-preview thumbnail" for="upload"><img id="image" src="{{asset('storage/images/company/'. $data->logo)}}" alt="Ảnh của bạn"
...
<!-- Input -->
                    ...
                    <div class="form-group col-lg-6 col-md-12">
                      ...
                      <select name="working_time" class="chosen-select">
                        ...
                        <option  value="{{$k}}" @if (isset($data->working_time) && $data->working_time == $k ) selected @endif>
                        {{ $v }}</option>
                        @endforeach
                      </select>
                    </div>
